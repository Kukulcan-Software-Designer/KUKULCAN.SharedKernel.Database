...
public sealed class KukulcanDbContextBaseTests
{
    ...
    public void OnModelCreating_ShouldApplySoftDeleteAndTenantFilters()
    {
        ...
        {
            Assert.That(
                context.Model.FindEntityType(typeof(SoftDeleteEntityForTests))!.GetQueryFilter(),
                Is.Not.Null);
            Assert.That(
                context.Model.FindEntityType(typeof(TenantEntityForTests))!.GetQueryFilter(),
                Is.Not.Null);
        });
    }
    ...
    public async Task SoftDeleteFilter_ShouldHideDeletedEntities()
    {
        ...
        var result = await context.SoftDeleteEntities.ToListAsync();
